...
} from '../../../features/landing/constants/paymentConfig'
import { formatRealAmount } from '../../../features/landing/utils/orderFormat'
import './CartDrawer.css'
import './Drawer.css'
import './OrderDrawer.css'

export function OrderPaymentsDrawerContent() {
  const { selectedOrder, formalizeOrderPayment } = useContext(AppContext)
