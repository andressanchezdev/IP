...
import { PROFILE_LEGAL_LINKS } from '../../../features/landing/data/mockProfile'
...
export function ProfileSettingsDrawerContent() {
  ...
  const [personalDraft, setPersonalDraft] = useState(profileSettings.personal)
  ...
  useEffect(() => {
    setPersonalDraft(profileSettings.personal)
