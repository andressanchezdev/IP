...
import { describeUnparseableWsPayload } from './wsDiagnostics'
...
function handleMessage(rawData) {
  ...
  if (!message) {
    if (import.meta.env.DEV) {
      const detail = describeUnparseableWsPayload(rawData)
      console.warn('[ws] Mensaje no parseable', detail.reason, detail)
    }
    return
  }
